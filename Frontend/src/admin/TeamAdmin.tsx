  ...
  return <Stack spacing={3}>
    ...
    <Stack direction={{xs:'column',md:'row'}} spacing={3} alignItems="flex-start">
      ...
      {form&&selected&&<Paper variant="outlined" sx={{p:3,flex:1,width:'100%'}}><Stack spacing={2}>
        ...
        {form.section==='practitioner'&&<TextField required label={t('Preferred public name')} value={form.booking_name} helperText={t('Used in friendly actions such as “Book with Esther”.')} inputProps={{maxLength:100}} onChange={event=>set('booking_name',event.target.value)}/>}
