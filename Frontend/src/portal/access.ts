...
export type PortalPage = 'dashboard' | 'appointments' | 'clients' | 'calendar' | 'business' | 'practitioners' | 'staff' | 'team' | 'widgets' | 'locations' | 'rooms' | 'services' | 'profile';
...
const slugs: Record<PortalPage, string> = { dashboard: '', appointments: 'appointments', clients: 'clients', calendar: 'availability', business: 'settings', practitioners: 'practitioners', staff: 'users', team: 'team', widgets: 'dashboard-widgets', locations: 'locations', rooms: 'rooms', services: 'services', profile: 'profile' };
