const en = {
  ...
  "Select a service to view its details or enable actions.": "Select a service to view its details or enable actions.",
  ...
  "Create the first service offered by the clinic.": "Create the first service offered by the clinic.",
  ...
  "Select a location to view its details or enable actions.": "Select a location to view its details or enable actions.",
  "No matching locations": "No matching locations",
  "Try a different location name or address.": "Try a different location name or address.",
  "No locations yet": "No locations yet",
  "Create the first clinic location or service area.": "Create the first clinic location or service area.",
  "Location details": "Location details",
  "Create a location": "Create a location",
  "Room actions": "Room actions",
  "New room": "New room",
  "Filter rooms": "Filter rooms",
  "Select a room to view its details or enable actions.": "Select a room to view its details or enable actions.",
  "No matching rooms": "No matching rooms",
  "Try a different room or location name.": "Try a different room or location name.",
  "No rooms yet": "No rooms yet",
  "Create the first room at a clinic location.": "Create the first room at a clinic location.",
  "Create a location before adding rooms.": "Create a location before adding rooms.",
  ...
  "Compare treatment options, prices, appointment formats, and the practitioners who provide them.": "Compare treatment options, prices, appointment formats, and the practitioners who provide them.",
  "Loading services": "Loading services",
  "No services have been published yet.": "No services have been published yet.",
  ...
  "Lowercase letters, numbers, and hyphens. Changing this URL may break saved links.": "Lowercase letters, numbers, and hyphens. Changing this URL may break saved links.",
  ...
  "Contact the clinic for practitioner availability.": "Contact the clinic for practitioner availability.",
