...
| Notifications | Durable records, immediate appointment email/staff SMS attempts, a 15-minute fallback worker, bilingual rendering, retries, and ambiguous-outcome review are implemented and live delivery tested; see `EMAIL_DELIVERY.md` | Editable templates, reminders, delivery webhooks, stronger monitoring, and broader recipient/channel support |
