...
$message = AppointmentEmail::compose($event, 'https://wellness.copihue.ca/client');
...
if (!str_contains($message['body'], '2026-09-22 10:00 EDT') || !str_contains($message['body'], 'https://wellness.copihue.ca/client')) throw new RuntimeException('Local time or portal link missing.');
...
foreach (['booking_change', 'booking_cancellation'] as $code) {
    $changed = AppointmentEmail::compose(array_replace($event, ['event_code' => $code]), 'https://wellness.copihue.ca/client');
